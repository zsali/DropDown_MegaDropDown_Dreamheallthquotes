      ...
      let n = r(4005),
        a = function (e) {
          for (
            ...
            a[o - 1] = arguments[o];
          return (0, n.normalizePathTrailingSlash)(r(5258).addLocale(e, ...a));
        };
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
      ...
      class X {
        ...
        async change(e, t, r, n, a) {
          ...
          try {
            ...
            let y =
              G && !d && !$ && !er && (0, M.compareRouterStates)(g, this.state);
            if (!y) {
              try {
                await this.set(g, o, d);
              } catch (e) {
